...
function FrontCard(props) {
    ...
    return(
        <div id="wrapper" className="bg_projects">
            <Header onChangeRoute={this.changeRoute} isOnline={this.props.checkUserStatus} />
        <h3>Se connecter</h3>
            <form>
            ...
            <Footer onChangeTab={this.changePage} onChangeRoute={this.changeRoute} toOpenModal={this.openModal} isOnline={this.props.checkUserStatus} />
        </div>
        );
}
// onClick={(e) => props.onFlip(e)}
